...
namespace WPFControl.Helper
{
    ...
    public class FTPHelper
    {
        ...
        public void upload(string remoteFile, byte[] localFile)
        {
            ...
            catch (Exception ex) { throw new Exception(remoteFile + "附件上传失败!"); }
            return;
            /* Open a File Stream to Read the File for Upload */
        }
        ...
        /// <returns></returns>
        public static BitmapImage GetImageFromFtpUrl(string ftpUrl)
        {
            System.Drawing.Image bmp = ftpUrl.GetImageFromNet(
            //(request) =>  
