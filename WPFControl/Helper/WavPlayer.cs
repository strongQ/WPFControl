...
namespace WPFControl.Helper
{
    public static class WavPlayer
    {
        ...
        [DllImport("winmm.dll", EntryPoint = "sndPlaySound", CallingConvention = CallingConvention.StdCall)]
        private static extern Int32 sndPlaySound(string lpszSoundName, Int32 uFlags);
        ...
        public static void StopPlay(string strFileName)
        {

            PlaySound(null, UIntPtr.Zero, (Int32)SoundFlags.SND_PURGE);
            //   sndPlaySound(strFileName, (Int32)SoundFlags.SND_PURGE);//停止播放
        }
        ...
        {
            sndPlaySound(strFileName, (Int32)SoundFlags.SND_SYNC);
        }
    }
}
